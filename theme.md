/**
 * themes.js - Wellness App Design System
 * Extracted from wellness UI design
 * Date: 2025-10-30
...
export const typography = {
  fontFamily: 'Poppins',              // Primary font family
 ...
 */
export function getLinearGradientProps(name) {
 ...
 */
export function getShadow(size = 'small') {
 ...
 */
export function withOpacity(color, opacityValue) {
  if (color.startsWith('#')) {
...
/*
// Example 1: Using with StyleSheet
...
// Example 2: Using with LinearGradient
import LinearGradient from 'react-native-linear-gradient';
import theme from './themes';

<LinearGradient
  {...theme.getLinearGradientProps('background')}
  style={styles.container}
>
  <Text>Content</Text>
</LinearGradient>

// Example 3: Using component tokens
